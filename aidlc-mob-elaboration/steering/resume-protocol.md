...
The AI-DLC process supports resuming interrupted sessions at any point.
...
| HANDOFF but status.md shows no specs created | User hasn't started spec work |
...
| Specs created | {count or "not yet"} |
...
1. Check `aidlc/status.md` for spec creation progress
...
The elaboration log and status dashboard are self-contained. Any agent or human
should be able to read them and understand the full state: intent, questions,
decisions, units, specs, and remaining work. Write in clear, complete prose.
